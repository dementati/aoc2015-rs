...
fn star1(input: String) -> i32 {
    ...
    for line in lines.into_iter() {
        for cap in re.captures_iter(&line) {
            ...
            sue.insert(cap[2].to_string(), *&cap[3].parse::<i32>().unwrap());
            sue.insert(cap[4].to_string(), *&cap[5].parse::<i32>().unwrap());
            sue.insert(cap[6].to_string(), *&cap[7].parse::<i32>().unwrap());
            data.insert(*&cap[1].parse::<i32>().unwrap(), sue);
        }
    }
